...
void BodyVisualizer::update_bone(const astra::JointList& joints, const float jointScale, astra::JointType j1, astra::JointType j2)
{
...
void BodyVisualizer::update_overlay(const astra::BodyMask& bodyMask, const astra::FloorMask& floorMask)
{
...
void BodyVisualizer::draw_text(sf::RenderWindow& window, sf::Text& text, sf::Color color, const int x, const int y) const
{
...
void BodyVisualizer::draw_help_message(sf::RenderWindow& window) const
{
...
void BodyVisualizer::toggle_paused()
{
	isPaused_ = !isPaused_;
}

bool BodyVisualizer::is_paused() const
{
	return isPaused_;
}

void BodyVisualizer::toggle_overlay()
{
	isMouseOverlayEnabled_ = !isMouseOverlayEnabled_;
}

bool BodyVisualizer::overlay_enabled() const
{
	return isMouseOverlayEnabled_;
}

void BodyVisualizer::toggle_help()
{
